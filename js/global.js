    ...
    <nav class="navbar">
      <div class="container navbar-inner">
        <a href="index.html" class="nav-logo">
          <img src="assets/images/Logomark.svg" alt="Logo" style="height:32px;" />
          LuxStore
        </a>
        <ul class="nav-links">
          <li><a href="index.html" class="${page === "index.html" ? "active" : ""}">Home</a></li>
          <li class="nav-dropdown">
            <a href="listing.html">Categories
          ...
          <div class="footer-grid">
            <div class="footer-brand">
              <a href="index.html" class="nav-logo" style="display:inline-flex;">
                <img src="assets/images/Logomark2.svg" alt="Logo" style="height:28px;" />
                LuxStore
              </a>
              <p>This website is just a showcase interface and is a university project.</p>
...
function updateNavAvatar() {
  ...
  if (avatar) {
    btn.innerHTML = `<img src="${avatar}" alt="Profile"
      style="width:38px;height:38px;border-radius:50%;object-fit:cover;display:block;" />`;
    btn.style.borderRadius = "50%";
  } else {
    btn.innerHTML = `<svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8"
...
// Override renderNavbar to call updateNavAvatar after
